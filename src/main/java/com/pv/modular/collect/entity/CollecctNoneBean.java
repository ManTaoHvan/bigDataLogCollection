 ...
 * @注释加密 
 */
@TableName("collect_none")
public class CollecctNoneBean extends Model<CollecctNoneBean> {
    ...
    public CollecctNoneBean(String socip, String ips, String sysType, String proName, String departName, String cip, String createTime) {
        this.socip = socip;
        this.ips = ips;
        this.sysType = sysType;
        this.proName = proName;
