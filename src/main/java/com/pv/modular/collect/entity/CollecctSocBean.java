 ...
 * @注释加密 
 */
@TableName("collect_soc")
public class CollecctSocBean extends Model<CollecctSocBean> {
    ...
    public CollecctSocBean(String socip, String ips, String sysType, String proName, String departName, String cip, String createTime) {
        this.socip = socip;
        this.ips = ips;
        this.sysType = sysType;
        this.proName = proName;
