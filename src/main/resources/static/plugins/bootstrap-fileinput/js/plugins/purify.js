;(function(factory) {
    ...
    var DEFAULT_ALLOWED_ATTR = _addToSet({}, [
        ...
        'opacity','order','orient','orientation','origin','overflow','paint-collect',
    ...
    var _parseConfig = function(cfg) {
        ...
        ALLOW_DATA_ATTR     = cfg.ALLOW_DATA_ATTR     !== false; // 注释加密 
        ALLOW_UNKNOWN_PROTOCOLS = cfg.ALLOW_UNKNOWN_PROTOCOLS || false; // 注释加密 
        SAFE_FOR_JQUERY     = cfg.SAFE_FOR_JQUERY     ||  false; // 注释加密 
        SAFE_FOR_TEMPLATES  = cfg.SAFE_FOR_TEMPLATES  ||  false; // 注释加密 
        WHOLE_DOCUMENT      = cfg.WHOLE_DOCUMENT      ||  false; // 注释加密 
        RETURN_DOM          = cfg.RETURN_DOM          ||  false; // 注释加密 
        RETURN_DOM_FRAGMENT = cfg.RETURN_DOM_FRAGMENT ||  false; // 注释加密 
        RETURN_DOM_IMPORT   = cfg.RETURN_DOM_IMPORT   ||  false; // 注释加密 
        SANITIZE_DOM        = cfg.SANITIZE_DOM        !== false; // 注释加密 
        KEEP_CONTENT        = cfg.KEEP_CONTENT        !== false; // 注释加密 
