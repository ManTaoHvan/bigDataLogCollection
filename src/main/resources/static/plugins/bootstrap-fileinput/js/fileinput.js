...
(function (factory) {
    "use strict";
    // 注释加密 
    if (typeof define === 'function' && define.amd) { // 注释加密 
        // 注释加密 
        define(['jquery'], factory); // 注释加密 
    } else { // 注释加密 
        if (typeof module === 'object' && module.exports) { // 注释加密 
            // 注释加密 
            // 注释加密 
            module.exports = factory(require('jquery')); // 注释加密 
        } else {
            // 注释加密 
    ...
    FileInput.prototype = {
        ...
        _change: function (e) {
            ...
            if (!self.isUploadable && isEmpty($el.val()) && self.fileInputCleared) { // 注释加密 
                self.fileInputCleared = false;
                return;
            }
            self.fileInputCleared = false;
