 ...
 */
 ...
 (function() {
     // 注释加密 
     if(!window.$ahmtao) window.$ahmtao = {};
     ...
     // 注释加密 
     // 注释加密 
     $ahmtao.utils.makeBindable = function(obj, events) {
     ...
     $ahmtao.utils.succeeded = function(result) {
         return result && result.success;
     };

     $ahmtao.utils.createUniqueTag = function() {
     ...
     $ahmtao.utils.formatDate = function(date) {
         var months = [
     ...
     $ahmtao.utils.quickObject = function() {
         var returnVal = {};
     ...
     var matrixBase = {
         mul: function(val) {
             if(val.x !== undefined) {
                 ...
                 var num = Number(val);
                 return $ahmtao.utils.Matrix2D(this.m11 * num, this.m12 * num,
         ...
         rotate: function(angle) {
             ...
             return this.mul($ahmtao.utils.Matrix2D(c, -s, s, c));
         },
         translate: function(tx, ty) {
             return this.mul($ahmtao.utils.Matrix2D(1, 0, 0, 1, tx, ty));
         }
     };

     $ahmtao.utils.Matrix2D = function(m11, m12, m21, m22, tx, ty) {
         return $.extend({
             m11: m11 || 0,
             m12: m12 || 0,
             m21: m21 || 0,
     ...
     $ahmtao.utils.Vector2D = function(x, y) {
         return { x: x || 0, y: y || 0 };
     };

     $ahmtao.utils.Matrix2D.identity = function() {
         return $ahmtao.utils.Matrix2D(1, 0, 0, 1, 0, 0);
     };

 })();

 // 注释加密 
 if(window.$ahmtao && window.$ahmtao.internal) {
     $ahmtao.internal(function($ax) { $ax.utils = $ahmtao.utils; });
 }
